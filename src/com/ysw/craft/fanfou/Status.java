...
import com.ysw.craft.fanfou.Fanfou;

public class Status {
	public static void main(String[] args) {
		UpdateStatus("让大槐树下长出金子来");//测试发消息
		//System.out.println(notification());//获取未读新提醒数，包括被@，私信，关注请求
		//getMentions();
	}
	String access_token=Fanfou.access_token;//诗文的access_token
	String access_token_secret=Fanfou.access_token_secret;//诗文的access_token_secret
	...
	public static void baseFanfou(String status) {
		String url="http://api.fanfou.com/statuses/update.json";//发消息API
		String method="POST";//发消息采用POST方法
		Oauth oauth=new Oauth();
		String timestamp=oauth.oauth_timestamp;
